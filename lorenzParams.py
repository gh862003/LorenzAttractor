...
nt_RK = 5000#5000 #7000 timestep <0.07 for dual attractor, <0.2 for solution 
nt_FB = 50#1500 #3500 timestep < 0.07, works for 0.06
nt_Eu = 15#350 #2500 350 timestep = <0.03, works for 0.02
...
variable_dtRK = [(0.0002)*1.000657559382988**i for i in range(nt_RK)]
...
variable_dtRK = [(0.00100029)+i*(3.6359701764e-7)for i in range(nt_RK)]
variable_timeRK = np.cumsum(variable_dtRK)
const_timeRK = np.cumsum([dt]*nt_RK)
var_typeRK = 'addition'
'''
...
#variables for the *a^n case
variable_dtEu = [(0.0008)*1.004646394358707**i for i in range(nt_Eu)]
...
variable_dtEu = [(0.0005)+i*(8.59598853868e-6) for i in range(nt_Eu)]
variable_timeEu = np.cumsum(variable_dtEu)
const_timeEu = np.cumsum([dt]*nt_Eu)
var_typeEu = 'addition'
'''
...
#variables for the *a^n case
variable_dtFB = [(0.0008)*1.001080347152962**i for i in range(nt_FB)]
...
#variables for the +n*a case
variable_dtFB = [(0.0010029)+i*(1.33035356905e-6) for i in range(nt_FB)]
variable_timeFB = np.cumsum(variable_dtFB)
const_timeFB = np.cumsum([dt]*nt_FB)
var_typeFB = 'addition'
'''
